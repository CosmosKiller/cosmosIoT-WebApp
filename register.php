...
if (isset($_POST['email']) && isset($_POST['password']) && isset($_POST['password_r']))
{
  ...
  if ($password==$password_r)
  {
    ...
    $result = $conn->query("SELECT `account_email` FROM `account` WHERE `account_email` = '".$email."' ");
    ...
    if ($count == 0){
      ...
      $conn->query("INSERT INTO `account` (`account_email`, `account_password`) VALUES ('".$email."', '".$password."');");
